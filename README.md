...
1. How would you describe acessibility on the web to someone new to programming?
  I would explain accesibility as a way to make the internet available to everyone no matter their need, disability or internet connection.

2. Talk about 3 different things you can do to ensure your website is accessible. 
  I can make sure that my website has a screen reader, make my website into a responsive design, and make sure that I design my website with the furtherest person out in mind. 

3. How would you explain the concept of a variable to someone new to programming? 
  I would say a variable is a container that store data in memory for later use. 

4. What is the purpose of using functions in code? To make code reuseable.
